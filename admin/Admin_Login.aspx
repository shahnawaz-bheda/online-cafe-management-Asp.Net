...
<body>
    ...
    <div class="loginbox">
        ...
        <form  runat="server">
            ...
            <asp:Button Text="Sign In" CssClass="btnsubmit" runat="server" OnClick="Unnamed5_Click" TabIndex="4"/>
            <asp:HyperLink Text="RegisterNow!" CssClass="hplreg" runat="server" NavigateUrl="Admin_Registrion.aspx"/>
        </form>
    </div>
